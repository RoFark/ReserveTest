...
def main():
    ...
    # selected_peril = st.selectbox('Select a Peril to Show Total Claim Count', [''] + sorted(data['PERIL'].unique()))
    # if selected_peril:
    #     peril_data = data[data['PERIL'] == selected_peril]
    #     summed_claim_count = peril_data['CLAIM_COUNT'].sum()
    #     st.write(f'Claim Count Sum for {selected_peril}: {summed_claim_count}')
